...
func TestMultiply_Commutativity_Rapid(t *testing.T) {
...
func TestMultiply_Nihil_Rapid(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		x := rapid.SliceOf(rapid.Uint()).Draw(t, "x")
...
func TestMultiply_ResultLessThanPart_Rapid(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
